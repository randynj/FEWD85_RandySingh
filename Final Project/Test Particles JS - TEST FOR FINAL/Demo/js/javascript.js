...
function renderButtonAnswers() {
  var answers = activeQuestion.answers,
      buttons = $('.options-container button');
...
function showResult() { 
  ...
  if (score > 15) {
    ...
    scoreRenderer(
      'Rusty Spike.', 'img/rail-spike.svg', 'Hmmm... seems like you&#39;ve got some Metra rides to take, and some studying to do. This old rail spike will make a nice paperweight.'
    );
